...
export const ID_NOTICE_HOTFAN_IN = withPrefix(ID_CHAT_LAYER_SET_DISPLAY_NOTICE, 'hotfan_in')
export const ID_NOTICE_HOTFAN = withPrefix(ID_CHAT_LAYER_SET_DISPLAY_NOTICE, 'hotfan')
